...
export default function Navbar({
	...
	useEffect(() => {
		...
		// 	(!("theme" in localStorage) && systemTheme);
						...
						<div className="space-y-4">
							<div>
								...
								<p className="text-xs text-slate-500 dark:text-zinc-400 mt-1">
									Enter your Google Gemini API Key to enable localized medical
									chat, Pidgin English drug translation, and smart symptom
									sifting. Your key remains private and is only stored in your
							...
							<div className="border-t border-slate-100 dark:border-zinc-800 pt-4">
								<span className="text-xs block text-slate-500 dark:text-zinc-400">
									💡 Don&apos;t have a key? You can get a free one from the Google AI
									Studio console. Otherwise, the app works perfectly fine in{" "}
									<strong>Local Mode</strong> using built-in rules and NIH
									databases.
								</span>
							</div>
						</div>
